...
const OT: BookInfo[] = [
  ...
  { name: 'Psalm', chapters: [6,12,8,8,12,10,17,9,20,18,7,8,6,7,5,11,15,50,14,9,13,31,10,10,12,12,14,9,11,12,11,11,22,23,28,12,40,22,13,17,13,11,5,26,10,12,6,13,21,23,5,8,7,23,19,11,11,17,12,12,8,12,5,14,20,27,20,23,13,5,24,20,23,5,12,9,18,13,10,13,6,11,11,13,8,10,7,5,13,16,15,11,8,23,8,13,6,9,8,7,7,7,5,7,7,10,5,6,4,7,6,7,8,6,7,7,6,5,4,6,3,5,5,3,5,3,2,4,3,3,2,3,3,2,2,3,3,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2] },
  ...
  { name: 'Isaiah', chapters: [31,22,26,6,30,13,25,22,21,34,16,6,22,32,9,14,14,7,25,6,17,25,18,23,12,21,13,29,24,33,9,20,24,17,10,22,38,22,8,31,29,25,28,28,25,13,15,22,26,11,23,15,12,17,13,12,21,14,21,22,11,12,19,11,25] },
  { name: 'Jeremiah', chapters: [19,37,25,31,31,30,34,22,26,25,23,17,27,22,21,21,27,23,15,18,14,30,40,10,38,24,22,17,32,24,40,44,26,22,19,32,16,28,18,16,18,22,13,30,5,28,7,47,39,46,64,34] },
...
export function getChapterCount(book: string): number {
  ...
  return found ? found.chapters.length : 0;
}

export function getVerseCount(book: string, chapter: number): number {
  const found = getBook(book);
  if (!found || chapter < 1 || chapter > found.chapters.length) return 0;
  return found.chapters[chapter - 1];
}
